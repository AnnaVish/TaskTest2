...
Функционал: СмоукТест Вебмастера и ЛК Вебмастера
  ...
  Сценарий: Проверка отображения вкладок Сводный Детализированный Единный оффер
    ...
    Когда вебмастер кликает на вкладку "Отчеты"
    Тогда вебмастеру отображается страница "Отчеты"
    Когда вебмастер выбирает "Единый оффер" в отчетах
    Тогда вебмастеру отображается результат выборки "Единый оффер" в отчетах
    Когда вебмастер выбирает "Детализированный" в отчетах
    Тогда вебмастеру отображается результат выборки "Детализированный" в отчетах
    Когда вебмастер выбирает "Сводный" в отчетах
    Тогда вебмастеру отображается результат выборки "Сводный" в отчетах
